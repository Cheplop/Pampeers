...
// Get the user ID from the session (this is the sitter's user ID)
$userId = $_SESSION['user_id'];
// Initialize an empty array to store the bookings
$sitterBookings = [];

// Prepare a query to get all bookings for this sitter, joining with users table for user details
$stmt = $conn->prepare("
    SELECT
        b.bookingID,
        b.uuid,
...
");
// Bind the user ID (sitter's user ID)
